...
<section class="food-search text-center">
    <div class="container">
        ...
        <h2>Foods on Your Search <a href="#" class="text-main">"<?php echo $search; ?>"</a></h2>
...
<section class="food-menu">
    <div class="container">
        ...
        <?php 
            ...
            //$search = cookie '; DROP database name;
            // "SELECT * FROM tbl_food1 WHERE title LIKE '%cookie'%' OR description LIKE '%cookie%'";
            ...
            {
                //Food Not Available
                echo "<div class='unavai'> Nothing matched with 
