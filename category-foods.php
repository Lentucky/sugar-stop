...
<section class="food-search text-center">
    <div class="container">
        ...
        <h2>Foods on <a href="#" class="text-">"<?php echo $category_title; ?>"</a></h2>
...
<section class="food-menu">
    <div class="container">
        ...
        <?php 
            ...
            {
                //Food not available
                echo "<div class='unavai'>Looks like there's no food in 
                <span style='color: #ec217b'>$category_title</span> 
                yet</div>";
            }
